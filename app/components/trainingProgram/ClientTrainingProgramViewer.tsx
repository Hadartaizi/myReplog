...
const styles = StyleSheet.create({
  ...
  headerBox: { backgroundColor: "#17171C", borderRadius: 18, borderWidth: 1, borderColor: "#2B2B31", padding: 14, alignItems: "flex-end", gap: 4 },
  title: { color: "#FFFFFF", fontSize: 18, fontWeight: "800", textAlign: "right" },
  subtitle: { color: "#B3B3B3", fontSize: 13, lineHeight: 20, textAlign: "right" },
  refreshButton: { minHeight: 46, backgroundColor: "#222229", borderRadius: 14, borderWidth: 1, borderColor: "#2B2B31", alignItems: "center", justifyContent: "center", paddingHorizontal: 16 },
  refreshButtonText: { color: "#FFFFFF", fontSize: 14, fontWeight: "800", textAlign: "center" },
  loaderWrap: { alignItems: "center", justifyContent: "center", paddingVertical: 28, gap: 10 },
  loaderText: { color: "#B3B3B3", fontSize: 14, textAlign: "center" },
  emptyBox: { backgroundColor: "#17171C", borderRadius: 18, borderWidth: 1, borderColor: "#2B2B31", paddingVertical: 24, paddingHorizontal: 18, alignItems: "center", justifyContent: "center", gap: 8 },
  emptyTitle: { color: "#FFFFFF", fontSize: 15, fontWeight: "800", textAlign: "center" },
  emptyText: { color: "#B3B3B3", fontSize: 14, textAlign: "center", lineHeight: 22 },
  choiceBox: { backgroundColor: "#17171C", borderRadius: 18, borderWidth: 1, borderColor: "#2B2B31", padding: 14, gap: 10 },
  choiceTitle: { color: "#FFFFFF", fontSize: 16, fontWeight: "800", textAlign: "center" },
  ...
  choiceButtonText: { color: "#FF9A3D", fontSize: 15, fontWeight: "900", textAlign: "center" },
  programCard: { backgroundColor: "#17171C", borderRadius: 18, borderWidth: 1, borderColor: "#2B2B31", padding: 14, gap: 12 },
  metaBox: { backgroundColor: "#222229", borderRadius: 14, borderWidth: 1, borderColor: "#2B2B31", padding: 12, alignItems: "flex-end", gap: 4 },
  metaLabel: { color: "#B3B3B3", fontSize: 12, fontWeight: "700", textAlign: "right" },
  metaValue: { color: "#FFFFFF", fontSize: 14, fontWeight: "700", textAlign: "right" },
  programScroll: { maxHeight: 620 },
  programScrollContent: { gap: 12, paddingBottom: 10 },
  sectionCard: { backgroundColor: "#222229", borderRadius: 16, borderWidth: 1, borderColor: "#2B2B31", padding: 12, gap: 10 },
  runningProgramsWrap: { gap: 14 },
  activeProgramBox: { gap: 10 },
  historyProgramsBox: { gap: 12, marginTop: 8 },
  historyProgramsHeading: { color: "#FFFFFF", fontSize: 17, fontWeight: "900", textAlign: "right", writingDirection: "rtl" },
  historyProgramCard: { backgroundColor: "#222229", borderWidth: 1, borderColor: "#2B2B31", borderRadius: 18, padding: 12, gap: 10 },
  ...
  historyProgramTitle: { color: "#FFFFFF", fontSize: 15, fontWeight: "900", textAlign: "right", writingDirection: "rtl" },
  historyProgramDate: { color: "#B3B3B3", fontSize: 12, fontWeight: "700", textAlign: "right", writingDirection: "rtl" },
  readOnlyClientNotesBox: { backgroundColor: "#222229", borderWidth: 1, borderColor: "#2B2B31", borderRadius: 14, padding: 12, gap: 6 },
  runningWeekCard: { backgroundColor: "#222229", borderRadius: 16, borderWidth: 1, borderColor: "#2B2B31", padding: 12, gap: 10 },
  ...
  expandText: { color: "#FF7A00", fontSize: 13, fontWeight: "900", textAlign: "left" },
  openContent: { gap: 10, paddingTop: 4 },
  sectionTitle: { color: "#FFFFFF", fontSize: 16, fontWeight: "800", textAlign: "right" },
  weekStatusText: { color: "#B3B3B3", fontSize: 12, fontWeight: "700", textAlign: "right" },
  weekClientNotesPreview: { color: "#EDEDED", fontSize: 12, fontWeight: "700", textAlign: "right", writingDirection: "rtl", marginTop: 4 },
  weekUpdatedPreview: { color: "#B3B3B3", fontSize: 11, fontWeight: "700", textAlign: "right", writingDirection: "rtl", marginTop: 2 },
  exerciseRow: { backgroundColor: "#17171C", borderRadius: 14, borderWidth: 1, borderColor: "#2B2B31", padding: 10, gap: 8 },
  exerciseName: { color: "#FFFFFF", fontSize: 15, fontWeight: "800", textAlign: "right" },
  exerciseStatsRow: { flexDirection: "row-reverse", gap: 8 },
  statBox: { flex: 1, backgroundColor: "#17171C", borderRadius: 12, borderWidth: 1, borderColor: "#2B2B31", padding: 10, alignItems: "center", justifyContent: "center", minHeight: 68 },
  statLabel: { color: "#B3B3B3", fontSize: 12, fontWeight: "700", textAlign: "center" },
  statValue: { color: "#FFFFFF", fontSize: 16, fontWeight: "800", textAlign: "center", marginTop: 4 },
  statValueSmall: { color: "#FFFFFF", fontSize: 12, fontWeight: "800", textAlign: "center", marginTop: 4, lineHeight: 18 },
  exerciseNotes: { color: "#B3B3B3", fontSize: 13, lineHeight: 20, textAlign: "right", backgroundColor: "#222229", borderRadius: 12, padding: 10 },
  notesBox: { backgroundColor: "#2A1A10", borderRadius: 14, borderWidth: 1, borderColor: "#FF7A00", padding: 12, gap: 6 },
  notesTitle: { color: "#FF9A3D", fontSize: 14, fontWeight: "800", textAlign: "right" },
  notesText: { color: "#FFFFFF", fontSize: 14, lineHeight: 22, textAlign: "right" },
  coachFeedbackBox: { backgroundColor: "#2A1A10", borderRadius: 14, borderWidth: 1, borderColor: "#FF7A00", padding: 10, gap: 5 },
  coachFeedbackTitle: { color: "#FF9A3D", fontSize: 13, fontWeight: "900", textAlign: "right" },
  coachFeedbackText: { color: "#FF9A3D", fontSize: 13, lineHeight: 20, fontWeight: "700", textAlign: "right" },
  feedbackBox: { backgroundColor: "#17171C", borderRadius: 14, borderWidth: 1, borderColor: "#2B2B31", padding: 10, gap: 9 },
  feedbackTitle: { color: "#FFFFFF", fontSize: 14, fontWeight: "800", textAlign: "right" },
